...
Auto-logout is supported for Gnome, KDE Plasma, Xfce, Deepin, i3, Openbox and AwesomeWM. You can disable it in the configuration file. In that case, the GPU switch will not be effective until the next login.
