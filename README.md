...
If you want to uninstall `optimus-manager`, run `optimus-manager --cleanup` before uninstalling to make sure there are no leftover autogenerated configuration files.
